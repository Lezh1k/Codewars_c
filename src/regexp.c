...
int regex2postfix(const char *regexp, int16_t **result, int *len,
...
static nfa_state_t *nfa_state(int32_t signal_, nfa_state_t *out1,
                              nfa_state_t *out2) {
...
static frag_t frag(nfa_state_t *start, ptrlst_nfa_states_t *out) {
  frag_t res = {.start = start, .out = out};
  return res;
}

/* Create ptr_list from aux_state*/
static ptrlst_nfa_states_t *ptrlst_constr(nfa_state_t **outp) {
...
static void ptrlst_patch(ptrlst_nfa_states_t *lst, nfa_state_t *s) {
...
static ptrlst_nfa_states_t *ptrlst_append(ptrlst_nfa_states_t *l1,
